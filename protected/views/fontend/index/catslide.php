                                ...
                                <div class="itemcatslide">
                                    <div class="catf">
                                        ...
                                        <div class="catf-caption">
                                            <a href="<?php echo $this->createUrl('archive/detail', array('alias' => $item['alias'])) ?>"><h2><?php echo $item['title'] ?></h2></a>
                                        </div>
                                    </div>
                                    <div class="listcat">
                                        ...
                                        <ul class="list-latestcat">
                                            ...
                                            foreach ($arr[0] as $item) {
                                                ?>
                                                <li>
                                                    <a href="<?php echo $this->createUrl('archive/detail', array('alias' => $item['alias'])) ?>"><?php echo $item['title'] ?></a>
                                                </li>
                                                <?php
                                            }
                                            ?>
                                    ...
                                    <div class="topcat">
                                        ...
                                        <ul class="list-topcat">
                                            ...
                                            foreach ($arr[1] as $item) {
                                                ...
                                                <li>
                                                    <div class="tthumb">
                                                        <a href="<?php echo $this->createUrl('archive/detail', array('alias' => $item['alias'])) ?>">
                                                            <img src="<?php echo $item['thumbnail'] ?>"
                                                                 alt="<?php echo CHtml::encode($item['title']) ?>"
                                                                 title="<?php echo CHtml::encode($item['title']) ?>" >
                                                        </a>
